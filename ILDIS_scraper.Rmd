...
Looks good. Next we will roll this up into a function and start pinging ILDIS for all of the species in the @Werner2014 nitrogen fixation dataset. The only issue might be if a name ever comes up with multiple entries in ILDIS, in which case this script will not work properly. We think we will identify those cases after running through once, and deal with it then if it is an issue for any species. Should be a pretty simple fix of grabbing the "accepted" name field and then following the linked URL to the species page.
