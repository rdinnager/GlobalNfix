...
N_fix_data <- N_fix_data[N_fix_data$Family == "Fabaceae", ] ## reduce to just legumes
save(legume_species, file = "data/legume_species.rda")
...
gbif_legumes <- gbif_dat_reduced %>%
  ...
  select(gbifID, decimalLatitude, decimalLongitude, genus, scientificName, 
         Species = species, taxonKey, genusKey, speciesKey)
